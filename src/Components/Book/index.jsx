    ...
    <div className="books_container">
      {items.map((item) => (
        <div key={item.id} class="book_container">
            <img className="placeholderImg"src="https://sun9-52.userapi.com/impg/dTYRUVe3JtBcG-UNxcW-BoHEiMoVf18mupzrXg/wA5qfwrYSNM.jpg?size=436x604&quality=96&sign=249b0f97a32f81acd6b386a8bbb8f0c0&type=album" alt="img"/>
